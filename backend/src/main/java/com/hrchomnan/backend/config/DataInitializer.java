...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initializePermissions() {
        ...
        List<Perm> defaultPermissions = List.of(
                ...
                new Perm(Role.Admin, "add_branch", true),
                new Perm(Role.Admin, "edit_branch", true),
                new Perm(Role.Admin, "delete_branch", true),
                ...
                new Perm(Role.HR, "add_branch", false),
                new Perm(Role.HR, "edit_branch", false),
                new Perm(Role.HR, "delete_branch", false),
                ...
                new Perm(Role.Manager, "add_branch", false),
                new Perm(Role.Manager, "edit_branch", false),
                new Perm(Role.Manager, "delete_branch", false),
                ...
                new Perm(Role.Employee, "add_branch", false),
                new Perm(Role.Employee, "edit_branch", false),
                new Perm(Role.Employee, "delete_branch", false),
