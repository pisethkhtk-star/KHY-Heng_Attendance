      ...
      <div className="glass-card p-6 rounded-2xl grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="space-y-1">
          ...
          <input
            ...
            className="w-full py-2 px-3 border border-white/10 bg-slate-950/60 text-white rounded-xl text-sm focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500/20 outline-none transition-all font-mono font-semibold"
          />
        </div>
          ...
          <>
            ...
            <div className="space-y-1">
              ...
              <select
                ...
                className="w-full py-2 px-3 border border-white/10 bg-slate-950/60 text-white rounded-xl text-sm focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500/20 focus:bg-slate-900 outline-none transition-all font-khmer cursor-pointer"
              >
